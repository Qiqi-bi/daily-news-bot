...
def get_updated_news_template():
    """
    返回基于您提供格式的新闻模板
    """
    template = """### [🔥+8] 1. 点击直达：全球AI芯片需求激增，台积电订单爆满
📅 来源：科技日报
...
def get_single_news_item_template():
    """
    返回单条新闻项目的模板
    """
    template = """### [🔥+热度] 编号. 点击直达：新闻标题
📅 来源：新闻来源
📝 核心事实：新闻的核心内容描述。
#### 📊 深度研报
 🇨🇳 对中国短期影响：对中国市场的短期影响分析。
 🔮 对中国长期影响：对中国市场的长期影响分析。
 📈 股市影响 (A股/港股/美股)：
     * 利好/利空板块：具体板块分析。
     * 底层逻辑：背后的逻辑分析。"""
...
if __name__ == "__main__":
    print("=== 更新版新闻模板 ===")
    print(get_updated_news_template())
    print("\n" + "="*60)
    print("=== 单条新闻项目模板 ===")
    print(get_single_news_item_template())