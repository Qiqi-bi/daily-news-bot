...
- 做预警时只写“可能发酵的主线、验证条件、失效条件和时间窗口”，不要写必涨必跌；尤其注意绿电算力、六氟化钨/WF6等电子特气、汇率/反内卷涨价权、政策压价行业、系统降本技术和右侧拥挤风险
- 政治暴力、刺杀、爆炸、政变等高风险事件只能按官方/主流媒体已确认内容写；不要推断幕后势力、阴谋动机或自导自演
...
- 对WF6、电子特气、前驱体、光刻/沉积/刻蚀材料等小品种，不按市场规模大小直接否定；要看不可替代性、客户认证、交期、库存、出口管制和价格传导
- 对政治暴力类素材，只能输出“待官方确认/已确认事实/仍无证据指向”的分层，不写未经证实的幕后推断
